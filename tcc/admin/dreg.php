...
$show = $result->FETCH(PDO::FETCH_OBJ);
 ...
 $qnt[$i] = $quantidade;
    ...
    <section class="content">
        <div class="page-announce valign-wrapper cyan darken-2"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign">Regiões</h1></div>
  <div class="container">
    <div class="row">
              <div class="col l3 s6">
          <!-- small box -->
 ...
 WHERE NOT EXISTS(SELECT 1
    ...
    $tipo = $exibir->tipo_doenca;
    $quant = $exibir->quantidade;
    $tot = $exibir->total;
                                                ?>
          <tr>
            ...
            <td><?php echo $tot ?></td>
            <td><?php echo $tipo ?></td>
            <td><a href="ver-reg.php?id=<?php echo $exibir->localidade; ?>" class="waves-effect waves-light btn"><i class="material-icons" style="font-size:25px;">visibility
            </i></a></td>
          </tr>
          <?php
