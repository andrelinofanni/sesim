...
if (isset($_SESSION['loginUser']) && (isset($_SESSION['senhaUser']))) {
  header("Location: ../user/lite/index.php");
  exit();
}
?>
<!DOCTYPE html>
      ...
      if (isset($_POST['login'])) {
        ...
        try {
          ...
          if ($verificar > 0) {
            ...
            header("Refresh: 1, ../user/lite/index.php");
          }else{
            echo '<br> <div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">×</button><strong>Erro!</strong> login ou senha incorretos, digite outro login, cadastre-se ou consulte o administrador :(</div>';
          }
