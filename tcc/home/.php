...
<html lang="en">
  <head>
    ...
    <title>SESIM - Sistema de Estatística de Saúde Integrado no Municipio</title>
  ...
  <body>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Bem vindo ao SUSIM</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">O seu Sistema Único de Saúde Implantado no Município</p>
              <a href="#" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">Entre ou cadastre-se</a>
            </div>
          </div>
        </div> 
      </div>           
    ...
    <div id="testimonial" class="section" data-stellar-background-ratio="0.1">
      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-md-12">
            <div class="touch-slider owl-carousel owl-theme" style="text-shadow: 0.5px 1px 0.5px black;">
              <div class="testimonial-item">
                <img src="img/testimonial/customer1.jpg" alt="Client Testimonoal" class="ft">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="submit-button text-center">
                        <button class="btn btn-rod" id="submit" type="submit">Send Message</button>
